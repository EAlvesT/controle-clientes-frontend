...
export function Sidebar({ children }: SidebarProps) {
    ...
    return (
        <div className="flex min-h-screen w-full bg-background text-foreground">
            ...
            <aside className={`fixed inset-y-0 left-0 z-40 w-72 flex justify-between flex-col gap-4 bg-white px-4 py-4 shadow-lg md:static md:z-auto md:w-64 md:shadow-none ${isOpen ? "block" : "hidden"} md:flex dark:text-background`}>
